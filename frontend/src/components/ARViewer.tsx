...
//       .then(res => {
//         if (!res.ok) throw new Error("Failed to fetch AR info");
//         return res.json();
//       })
//       .then(data => {
//         if (!data.ar_available) {
//           setError("AR is not available for this product");
//         } else {
//           setArInfo(data);
//         }
//         setLoading(false);
...
//       {/* MODEL VIEWER (NO JSX → NO TS ERROR) */}
//       <div
