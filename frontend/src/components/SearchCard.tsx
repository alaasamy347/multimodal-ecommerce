...
//       ? image_url
//       : "/placeholder.jpg"; // frontend fallback
...
//               className="flex-1 py-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg flex items-center justify-center gap-2"
//             >
        ...
        <div className="p-4 space-y-3">
          ...
          {onAddToCart && (
            <button onClick={onAddToCart}
              className="flex-1 py-2 bg-violet-600 text-white text-xs rounded-lg hover:bg-violet-700 transition-colors font-medium">
              + Add to Cart
            </button>
          )}
        </div>
